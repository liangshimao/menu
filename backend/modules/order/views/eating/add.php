...
<div style="padding:8px;">
        <form action="<?php echo Url::toRoute('/order/eating/add')?>" method="post" id="myform">
            <table class="table table-bordered table-striped table-hover table-condensed">
                ...
                <tr>
                    ...
                    <td colspan="5"><input type="text" value="" class="form-control" width="60%" name="table" id="table"></td>
                    <td colspan="4"></td>
                </tr>
                ...
                <tr style="text-align: center;" class="detail_list">
                    ...
                    <td colspan="3">
                        <select class="form-control width-120 detail-food" name="detail[0][food_id]">
                            <option value="">-菜品名称-</option>
                        </select>
                    </td>
                    <td colspan="1"><input type="number" min="1" value="1" class="form-control num" name="detail[0][count]" style="width:60px;"></td>
                    <td colspan="3"><input type="text" value="" class="form-control" name="detail[0][remark]" ></td>
                    <td colspan="1"><a class="btn btn-info btn-sm" href="javascript:void(0);" id="btnAdd"><i class="glyphicon glyphicon-plus-sign"></i> 新增</a></i></td>
                </tr>
